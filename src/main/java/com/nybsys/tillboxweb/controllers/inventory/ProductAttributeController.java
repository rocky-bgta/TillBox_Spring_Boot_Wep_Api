...
import com.nybsys.tillboxweb.models.inventory.ProductAttributeModel;
...
@RestController
@RequestMapping(InventoryModuleConstant.PRODUCT_ATTRIBUTE_BASE_URL)
@Api(tags = "Inventory")
public class ProductAttributeController {


    @ApiOperation(value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_SAVE_DESCRIPTION, response = ProductAttributeModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        lock = requestHelper.getLock(InventoryModuleConstant.PRODUCT_ATTRIBUTE_BASE_URL + InventoryModuleConstant.SAVE
    ...
    @ApiOperation(value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_DELETE_DESCRIPTION, response = ProductAttributeModel.class)
    ...
    public ResponseMessage delete(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(InventoryModuleConstant.PRODUCT_ATTRIBUTE_BASE_URL + InventoryModuleConstant.DELETE
                ,WORKER_INVENTORY_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
    ...
    @ApiOperation(value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_SEARCH_DESCRIPTION, response = ProductAttributeModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(InventoryModuleConstant.PRODUCT_ATTRIBUTE_BASE_URL + InventoryModuleConstant.SEARCH
                ,WORKER_INVENTORY_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
    ...
    @ApiOperation(value = InventoryModuleConstant.PRODUCT_ATTRIBUTE_INACTIVE_DESCRIPTION, response = ProductAttributeModel.class)
    ...
    public ResponseMessage inactive(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(InventoryModuleConstant.PRODUCT_ATTRIBUTE_BASE_URL + InventoryModuleConstant.INACTIVE
                ,WORKER_INVENTORY_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
