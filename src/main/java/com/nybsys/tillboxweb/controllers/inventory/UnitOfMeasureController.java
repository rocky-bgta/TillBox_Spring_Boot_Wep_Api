...
import com.nybsys.tillboxweb.models.inventory.UnitOfMeasureModel;
...
@RestController
@RequestMapping(InventoryModuleConstant.UNIT_OF_MEASURE_BASE_URL)
@Api(tags = "Inventory")
public class UnitOfMeasureController {

    @ApiOperation(value = InventoryModuleConstant.UNIT_OF_MEASURE_SAVE_DESCRIPTION, response = UnitOfMeasureModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        lock = requestHelper.getLock(InventoryModuleConstant.UNIT_OF_MEASURE_BASE_URL+InventoryModuleConstant.SAVE
    ...
    @ApiOperation(value = InventoryModuleConstant.UNIT_OF_MEASURE_SEARCH_DESCRIPTION, response = UnitOfMeasureModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(InventoryModuleConstant.UNIT_OF_MEASURE_BASE_URL+InventoryModuleConstant.SEARCH
                ,WORKER_INVENTORY_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
    ...
    @ApiOperation(value = InventoryModuleConstant.UNIT_OF_MEASURE_INACTIVE_DESCRIPTION, response = UnitOfMeasureModel.class)
    ...
    public ResponseMessage inactive(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(InventoryModuleConstant.UNIT_OF_MEASURE_BASE_URL+InventoryModuleConstant.INACTIVE
                ,WORKER_INVENTORY_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
