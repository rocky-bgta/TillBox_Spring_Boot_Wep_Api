...
@RestController
@RequestMapping(UserRegConst.BUSINESS_CONTACT_BASE_URL)
@Api(tags = "User-Registration",value = UserRegConst.BUSINESS_CONTACT_CONTROLLER_NAME, description = UserRegConst.BUSINESS_CONTACT_CONTROLLER_DESCRIPTION)
public class BusinessContactController {

    @ApiOperation(value = UserRegConst.BUSINESS_CONTACT_SAVE_DESCRIPTION, response = BusinessContactModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        lock = requestHelper.getLock(UserRegConst.BUSINESS_CONTACT_BASE_URL+ UserRegConst.SAVE, WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
    ...
    @ApiOperation(value = UserRegConst.BUSINESS_CONTACT_GET_BY_ID_DESCRIPTION, response = BusinessContactModel.class)
    ...
    public ResponseMessage getByID(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(UserRegConst.BUSINESS_CONTACT_BASE_URL+ UserRegConst.GET_BY_ID, WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock,publishedMessageId);
    ...
    @ApiOperation(value = UserRegConst.BUSINESS_CONTACT_SEARCH_DESCRIPTION, response = BusinessContactModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(UserRegConst.BUSINESS_CONTACT_BASE_URL+ UserRegConst.SEARCH, WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock,publishedMessageId);
