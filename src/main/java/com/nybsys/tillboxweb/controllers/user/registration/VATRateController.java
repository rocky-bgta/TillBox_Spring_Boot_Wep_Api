...
@RestController
@RequestMapping(UserRegConst.VAT_RATE_BASE_URL)
@Api(tags = "User-Registration", value = UserRegConst.VAT_RATE_CONTROLLER_NAME, description = UserRegConst.BUSINESS_CONTACT_CONTROLLER_DESCRIPTION)
public class VATRateController extends Core {

    @ApiOperation(value = UserRegConst.VAT_RATE_SAVE_DESCRIPTION, response = VATRateModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        lock = requestHelper.getLock(UserRegConst.VAT_RATE_BASE_URL + UserRegConst.SAVE, WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
    ...
    @ApiOperation(value = UserRegConst.VAT_RATE_SEARCH_DESCRIPTION, response = VATRateModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(UserRegConst.VAT_RATE_BASE_URL+ UserRegConst.SEARCH , WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock,publishedMessageId);
