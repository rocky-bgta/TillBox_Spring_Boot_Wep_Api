...
@RestController
@RequestMapping(UserRegConst.DOCUMENT_NUMBER_BASE_URL)
@Api(tags = "User-Registration",value = UserRegConst.DOCUMENT_NUMBER_CONTROLLER_NAME, description = UserRegConst.BUSINESS_CONTACT_CONTROLLER_DESCRIPTION)
public class DocumentNumberController {

    @ApiOperation(value = UserRegConst.DOCUMENT_NUMBER_SAVE_DESCRIPTION, response = VMDocumentNumber.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        lock = requestHelper.getLock(UserRegConst.DOCUMENT_NUMBER_BASE_URL+ UserRegConst.SAVE , WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
    ...
    @ApiOperation(value = UserRegConst.DOCUMENT_NUMBER_SEARCH_DESCRIPTION, response = DocumentNumberModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(UserRegConst.DOCUMENT_NUMBER_BASE_URL+ UserRegConst.SEARCH , WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock,publishedMessageId);
