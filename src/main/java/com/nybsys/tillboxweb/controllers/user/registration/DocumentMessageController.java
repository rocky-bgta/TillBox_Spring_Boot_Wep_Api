...
@RestController
@RequestMapping(UserRegConst.DOCUMENT_MESSAGE_BASE_URL)
@Api(tags = "User-Registration", value = UserRegConst.DOCUMENT_MESSAGE_CONTROLLER_NAME, description = UserRegConst.BUSINESS_CONTACT_CONTROLLER_DESCRIPTION)
public class DocumentMessageController {

    @ApiOperation(value = UserRegConst.DOCUMENT_MESSAGE_SAVE_DESCRIPTION, response = VMDocumentMessage.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        lock = requestHelper.getLock(UserRegConst.DOCUMENT_MESSAGE_BASE_URL + UserRegConst.SAVE , WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
    ...
    @ApiOperation(value = UserRegConst.DOCUMENT_MESSAGE_SEARCH_DESCRIPTION, response = DocumentMessageModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(UserRegConst.DOCUMENT_MESSAGE_BASE_URL + UserRegConst.SEARCH , WORKER_USER_REGISTRATION_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock,publishedMessageId);
