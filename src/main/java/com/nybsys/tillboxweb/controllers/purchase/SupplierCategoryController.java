...
import com.nybsys.tillboxweb.models.purchase.SupplierCategoryModel;
...
@RestController
@RequestMapping(PurchaseModuleConstant.SUPPLIER_CATEGORY_BASE_URL)
@Api(tags = "Purchase")
public class SupplierCategoryController {

    @ApiOperation(value = PurchaseModuleConstant.SUPPLIER_CATEGORY_SAVE_DESCRIPTION, response = SupplierCategoryModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        lock = requestHelper.getLock(PurchaseModuleConstant.SUPPLIER_CATEGORY_BASE_URL + PurchaseModuleConstant.SAVE
    ...
    @ApiOperation(value = PurchaseModuleConstant.SUPPLIER_CATEGORY_SEARCH_DESCRIPTION, response = SupplierCategoryModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(PurchaseModuleConstant.SUPPLIER_CATEGORY_BASE_URL + PurchaseModuleConstant.SEARCH
                , WORKER_PURCHASE_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
    ...
    @ApiOperation(value = PurchaseModuleConstant.SUPPLIER_CATEGORY_GET_BY_ID_DESCRIPTION, response = SupplierCategoryModel.class)
    ...
    public ResponseMessage getByID(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(PurchaseModuleConstant.SUPPLIER_CATEGORY_BASE_URL + PurchaseModuleConstant.GET_BY_ID
                , WORKER_PURCHASE_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
