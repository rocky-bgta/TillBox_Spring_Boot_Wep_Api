...
@RestController
@RequestMapping(PurchaseModuleConstant.SUPPLIER_ADDRESS_TYPE_BASE_URL)
@Api(tags = "Purchase")
public class SupplierAddressTypeController {

    @ApiOperation(value = PurchaseModuleConstant.SUPPLIER_ADDRESS_TYPE_SAVE_DESCRIPTION, response = AddressTypeModel.class)
    ...
    public ResponseMessage save(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        lock = requestHelper.getLock(PurchaseModuleConstant.SUPPLIER_ADDRESS_TYPE_BASE_URL + PurchaseModuleConstant.SAVE
    ...
    @ApiOperation(value = PurchaseModuleConstant.SUPPLIER_ADDRESS_TYPE_SEARCH_DESCRIPTION, response = AddressTypeModel.class)
    ...
    public ResponseMessage search(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(PurchaseModuleConstant.SUPPLIER_ADDRESS_TYPE_BASE_URL + PurchaseModuleConstant.SEARCH
                , WORKER_PURCHASE_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
    ...
    @ApiOperation(value = PurchaseModuleConstant.SUPPLIER_ADDRESS_TYPE_GET_BY_ID_DESCRIPTION, response = AddressTypeModel.class)
    ...
    public ResponseMessage delete(@RequestBody RequestMessage requestMessage) throws MqttException {
        ...
        RequestHelper requestHelper = new RequestHelper();
        lock = requestHelper.getLock(PurchaseModuleConstant.SUPPLIER_ADDRESS_TYPE_BASE_URL + PurchaseModuleConstant.GET_BY_ID
                , WORKER_PURCHASE_MODULE_TOPIC, requestMessage);
        publishedMessageId = requestHelper.getPublishedMessageId();
        responseMessage = requestHelper.getResponse(lock, publishedMessageId);
